...
public class UserControllerTest {
    ...
    public void register_success() throws Exception {
        ...
        userRegisterRequest.setEmail("test44@gmail.com");
        userRegisterRequest.setPassword("6666");
        ...
        mockMvc.perform(requestBuilder)
                ...
                .andExpect(jsonPath("$.email", equalTo("test44@gmail.com")))
    ...
    public void register_emailAlreadyExist() throws Exception {
        // 先註冊一個帳號
        UserRegisterRequest userRegisterRequest = new UserRegisterRequest();
        userRegisterRequest.setEmail("jj444@gmail.com");
        userRegisterRequest.setPassword("11");
